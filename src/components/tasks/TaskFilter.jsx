 ...
 * by completion status and search by title. Now includes context-aware sidebar
 * functionality that automatically detects admin vs user context.
 * 
 * Features:
 * - Filter tasks by completion status (All/Complete/Incomplete)
 * - Search tasks by title with real-time results
 * - Context-aware sidebar (Admin or User based on current route)
...
const TaskFilter = () => {
  ...
  // Detect if this is admin or user context based on route
